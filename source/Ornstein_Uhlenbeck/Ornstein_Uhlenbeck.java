...
public class Ornstein_Uhlenbeck extends WholeCharModelCurator implements CTSubModelCurator  {
	...
	public Object doCommand(String commandName, String arguments, CommandChecker checker) {
		...
		if (checker.compare(this.getClass(), "Sets Model to default", "[name of character model]", commandName, "setDefault")) {
				...
				if (model !=null && model instanceof Ornstein_UhlenbeckModel) {
						...
						CharMatrixSource charTask = (CharMatrixSource)this.hireEmployee(CharMatrixSource.class, "Source of traits");
	...
	/*.................................................................................................................*/
 	public MesquiteModule editModelNonModal(CharacterModel model, ObjectContainer w){
		if (model!=null && model instanceof Ornstein_UhlenbeckModel) {
				Ornstein_UhlenbeckModel modelToEdit =  ((Ornstein_UhlenbeckModel)model);
		/*double a = 0;//modelToEdit.getRate();
				MesquiteModule windowServer = hireNamedEmployee(WindowHolder.class, "#WindowBabysitter");
				if (windowServer == null)
					return null;
				SliderWindow sw = new SliderWindow(windowServer, "Edit model", "Model \"" + modelToEdit.getName() + "\"", makeCommand("setRate", modelToEdit), 0,0.0, MesquiteDouble.infinite, 1.0, 5.0);  //MesquiteDouble.infinite
			...
			cw.makeCommandFieldln("Root state of trait :","rootstate",modelToEdit,root_state,makeCommand("setRootState", modelToEdit));
			cw.makeCommandField("Root state of peak","rootpeak",modelToEdit,root_peak,makeCommand("setRootPeak", modelToEdit));
			cw.makeCommandFieldln("Variance of peak at tips :","peakvar",modelToEdit,peak_var,makeCommand("setpeak_var", modelToEdit));
			cw.makeCommandField("Mean of peak at tips :","meantippeak",modelToEdit,mean_tip_peak,makeCommand("setMeanTipPeak", modelToEdit));
			cw.makeCommandField("Mean of trait at tips :","meantipstate",modelToEdit,mean_tip_state,makeCommand("setMeanTipState", modelToEdit));
			cw.makeCommandFieldln("decay :","decay",modelToEdit,decay,makeCommand("setdecay", modelToEdit));
