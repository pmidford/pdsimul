...
public class CorTraitCurWindow extends MesquiteWindow {
	...
	public CorTraitCurWindow(MesquiteModule module, String title, String name, MesquiteCommand command, double initialValue, double min, double max, double minSweet, double maxSweet) {
		super(module, true);
    ...
    public WindowDoubleField makeCommandField(String name, double value, MesquiteCommand command){
    	return makeCommandField(name, command, value,gridbag, c, false);
    }

    public WindowDoubleField makeCommandFieldln(String name, double value, MesquiteCommand command){
    	return makeCommandField(name, command, value,gridbag, c, true);
    }    
    ...
    protected WindowDoubleField makeCommandField(String label, MesquiteCommand command, double value, GridBagLayout gridbag, GridBagConstraints c, boolean EndLine){
    	WindowDoubleField df=new WindowDoubleField(command, value);
    	//TextField tf = new TextField(str);
