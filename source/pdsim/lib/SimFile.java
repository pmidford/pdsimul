...
public class SimFile {
	public static void MakeSimFile(CoVarMatrixModel model, String directory, String str, Tree tree, ContinuousHistory sim[][], int num_of_runs) throws Exception {
        File file = new File(directory, str+".sim");
