...
public abstract class ResultsCurator extends MesquiteModule implements DataCurator {
	...
	/*public  MesquiteProject getPassProject(){
		return passproj;
	}*/
	public abstract Results makeempty(String name);
 	...
 	public abstract Results subfinish(CoVarMatrixModel model, String name, String description, MesquiteInteger stringPos, int format);
 	
 	public Results finish(CoVarMatrixModel model, String name, String description, MesquiteInteger stringPos, int format){
 		Results result;
 		result=subfinish(model, name, description, stringPos, format);
...
//	public abstract boolean curatesModelClass(Class resultsClass);
	...
	/*.................................................................................................................*/
    	 public Object doCommand(String commandName, String arguments, CommandChecker checker) {
			...
			String name = MesquiteString.queryShortString(containerOfModule(), "New "+getName(), "Name of new "+getName()+":", getNewName());//getProject().getCharacterModels().getUniqueName(getName()));
	...
	/**Edit model.  Editing to be done in non-modal window.  Methods not using window holder service could override this.  Returns the module that owns the window produced.*/
 	...
 	String getNewName(){
 		int inc=0;
		ResultsNamesLister names = new ResultsNamesLister(getProject(), Results.class);
		String[] list=names.getStrings();
 		for(int x=0;x<list.length;x++){
 			if (list[x].contains(getName())){
 				inc++;
 			}
 		}
 		return getName()+" "+inc;
