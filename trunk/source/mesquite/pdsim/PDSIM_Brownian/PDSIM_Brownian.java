	...
	/*.................................................................................................................*/
  	public MesquiteModule editModelNonModal(CharacterModel model, ObjectContainer w){
		if (model!=null && model instanceof PDSIM_BrownianModel) {
			...
			cw.makeCommandField("trait_var:",trait_var,makeCommand("settrait_var", modelToEdit));
			cw.makeCommandFieldln("Root State:",root_state,makeCommand("setroot_state", modelToEdit));
			cw.makeCommandField("variance of states at tips :",mean_var,makeCommand("setmean_var", modelToEdit));
			cw.makeCommandFieldln("mean state at tips :",meanTipState,makeCommand("setmeanTipState", modelToEdit));
